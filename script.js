...
const questions = [
  ...
  `Sais-tu contrôler tes mots et tes actes lorsque tu es énervée ?`,
  ...
  `tu m’as dit que tu te lassais tres vite, comment vois tu l’évolution de ton mariage, de ton couple sachant cela ?`,
  ...
  `As-tu de bons liens avec ta famille paternelle ?`,
  ...
  `Souhaites-tu continuer à travailler après le mariage et/ou après avoir eu des enfants ? Serais-tu prête à adapter ou arrêter ton activité si l'équilibre de notre foyer en dépend?`,
  ...
  `Comment vois -tu les sorties, les soirées ou les voyages entre copines une fois mariée ?`,
  ...
  `Est-ce que tu aides tes parents au quotidien ? De quel manière ?`,
  `concernant ton msg le dimanche 15 fevrier 2026 à 00h42 je cite : « C’est ova comme t’as dis » , t’étais serieuse quand t’as envoyé le msg ?`,
  `Comment tu as su pour le dars de Cheikh Sidi sur les relations hors mariage ?`,
  `Est -ce que c'est vraiment t'as copine qui m'a appelé junkie ?`,
  `tu pense quoi de moi, tes craintes, pourquoi tu continues à parler avec moi ,pourquoi moi et pas un autre (la question de RH 😂😂),j’ai besoin de savoir explicitement si tes sentiments sont réciproques ?`,
  `Une note sur 10 sur le site ?`
];
