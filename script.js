...
Encore une fois, c’est moi qui te contacte. Je sais que je me contredis, mais malheureusement je ne suis qu’un simple humain qui a ses faiblesses (et malheureusement, qui est faible face à la personne que je veux appeler ma femme).`,
  ...
  `Ce n’est pas contre toi que je voulais qu’on arrête de parler. Je devenais trop dépendant de notre relation, je pensais à toi avec excès, je n’arrivais plus à me concentrer. Parler avec toi devenait comme une drogue(comme un junkie…), mais je ne voulais pas trop forcer car je ne savais pas si tu m’appréciais autant que moi je t’appréciais.`,
  ...
  `Joyeux anniversaire ❤️l’amoureuse des chats (désolé c’est plus une déclaration qu’un message d’anniversaire).`,
  `Merci pour tout ce que tu m’as apporté.

Ton junkie préféré.`,
  '<div class="conteneur-photo"><img id="image" src="img/M+F.jpg" alt="Image"><img id="coeur-initiales" src="img/coeur-mf.png" alt="Coeur M+F"></div>'
];
